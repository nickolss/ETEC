...
<html lang="pt-br">
	...
	<body class="bg-dark text-white">
		<header class="cabecalho">
			<nav class="navbar navbar-dark bg-dark fixed-top pb-1">
					...
					>
						...
						<div class="offcanvas-body">
							<ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
								...
								<li class="nav-item">
									<a class="nav-link" aria-current="page" href="cadastrar.html"
										>Inscrever-se</a
									>
								</li>
								<li class="nav-item">
		...
		<main class="container text-white mt-5">
			...
			<section class="formula row">
				<div class="col">
					...
					<code class="formula__codigo"
						><abbr title="Tamanho da Chance">TC</abbr> = (<abbr
							title="Resiliência"
							>R</abbr
						>
						+ <abbr title="Inteligência">I</abbr> = X) _ (<abbr
		...
		<footer class="rodape row text-center py-4">
			<div class="col">
				<p class="rodape__creditos">
					...
					<a href="https://github.com/nickolss" target="_blank"
						>Nickolas Maia de Araujo</a
					>
				</p>
			</div>
		</footer>
