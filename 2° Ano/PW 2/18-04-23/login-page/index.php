    ...
    <main class="main">
        <div class="formulario">
            ...
            <form class="formulario__perguntas">
                ...
                <input type="email" name="email" id="email" placeholder="Email" class="perguntas__input">
                <input type="password" name="senha" id="senha" placeholder="Senha" class="perguntas__input" >
